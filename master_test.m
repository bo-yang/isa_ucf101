path = pwd; %current folder
%path='/home/boyang/UCF101/isa_src';

% ***CHANGE TO DESIRED PATHS***
params.afspath = [path,'/ucfTrainTestlist/'];
params.savepath = [path,'/test_savepath/']; %path to save intermediate (before svm classification) results
...
%path to videos
params.avipath{1} = '/home/boyang/UCF101/UCF-101_resized05/';%[path,'/UCF-101_resized_40x30/']; %% Change this path accordingly %%
...
params.num_km_init = 4; %number of random kmeans initializations
...
params.unscramble = 0; %1; %set 1 Hollywood2: deal with multiple labels/clip
...
%% execute
fprintf('\n--- Feature extraction and classification (UCF101) ---\n')
